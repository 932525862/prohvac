        ...
        <Container>
            <div className='flex flex-col items-start'>
                ...
                {/* <button data-aos='fade-left' data-aos-duration='800' data-aos-delay='300' className='border-[1px] border-white text-white rounded-2xl py-2 px-6 hover:bg-white hover:text-main font-bold transition-colors duration-300'> */}
                    <a data-aos='fade-left' data-aos-duration='800' data-aos-offset='70' data-aos-delay='300' className='border-[1px] block border-white text-white rounded-2xl py-2 px-6 hover:bg-white hover:text-main font-bold transition-colors duration-300' href="#projects">{t('about.a')}</a>
                {/* </button> */}
