      ...
      <Container>
        <div className="flex justify-center">
          <ul className="hidden md:flex items-center md:gap-7 lg:gap-12">
            <li className="text-[13px] lg:text-[16px] hover:border-b-[1px] border-b-white">
            ...
            <li className="relative group cursor-pointer">
              ...
              <div className="flex-col gap-1 bg-black overflow-hidden text-white rounded-xl w-[55px] absolute transition-all duration-300 transform scale-0 top-full left-1/2 -translate-x-1/2 opacity-0 group-hover:scale-100 group-hover:opacity-100 group-hover:flex">
                <button onClick={e=>changeLang('en')} className="hover:bg-white pt-2 hover:text-black w-full">
                  EN
                </button>
                <button onClick={e=>changeLang('ru')} className="hover:bg-white hover:text-black w-full">
                  RU
                </button>
          ...
          <ul className="flex md:hidden items-center justify-between w-full">
            <li>
                <button onClick={e=>setOpen(true)} className="text-white bg-secondary rounded-full p-3 text-lg"><GiHamburgerMenu/></button>
            </li>
            <li>
                <a href="#"><img className="object-contain w-[110px]" src={logo} alt="" /></a>
            </li>
            <li>
          ...
          <div className={`h-full md:hidden fixed left-0 top-0 bg-primary w-[290px] pt-4 px-4 transition-transform duration-500 ${!open?'translate-x-[-110%]':'translate-x-[0%]'}`}>
            <div className="w-full flex justify-end">
                <button onClick={e=>setOpen(false)} className="bg-primary-light text-main font-extrabold rounded-full p-2 text-lg">
                    <IoClose/>
                </button>
            </div>
            ...
            <li className="">
              <div className="flex justify-start gap-3">
                <button onClick={e=>changeLang('en')} className="hover:bg-white hover:text-black font-bold">
                  EN
                </button>
                <button onClick={e=>changeLang('ru')} className="hover:bg-white hover:text-black font-bold">
                  RU
                </button>
