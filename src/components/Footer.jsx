        ...
        <Container>
            <div data-aos='zoom-in' data-aos-duration='700' data-aos-delay='140' className='flex flex-col sm:flex-row items-center sm:items-start sm:justify-between gap-10 sm:gap-5'>
                ...
                <div className='flex flex-col gap-3'>
                    ...
                    <a className='hover:border-b-black w-[84%] border-transparent border-b-2 transition-all duration-300 opacity-90 text-lg sm:text-xl' href="tel:+998994625045">+998994625045</a>
                    <a className='hover:border-b-black w-[84%] border-transparent border-b-2 transition-all duration-300 opacity-90 text-lg sm:text-xl' href="tel:+998994625045">+998994625045</a>
                </div>
            </div>
        </Container>
